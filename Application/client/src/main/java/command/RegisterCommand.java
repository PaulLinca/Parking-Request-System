...
public class RegisterCommand implements Command<UserDTO>
{
    private LoginController loginController;

    public RegisterCommand(LoginController loginController)
    {
    ...
    public UserDTO execute()
    {
        ...
        myRequest.getParams().put("command", "register");
        ...
        try (Socket clientSocket = new Socket("127.0.0.1", 1997))
        {
            ...
            {
                loginController.clearTextBoxes();
            }
        }
        catch (IOException e)
        {
